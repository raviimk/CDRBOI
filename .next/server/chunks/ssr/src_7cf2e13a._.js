...
"[project]/src/app/sarin/return/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ReturnSarinLotPage() {
    ...
    const [returningOperator, setReturningOperator] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const unreturnedLots = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const lots = {};
        sarinPackets.filter((p)=>!p.isReturned).forEach((p)=>{
            if (!lots[p.lotNumber]) {
                lots[p.lotNumber] = {
...
//# sourceMappingURL=src_7cf2e13a._.js.map